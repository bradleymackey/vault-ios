...
final class AESGCMDecryptorTests: XCTestCase {
    ...
    func test_decrypt_decryptsNonEmptyMessage() throws {
        ...
        let message = AESGCMEncryptedMessage(
            ciphertext: Data(hex: "0x42831ec2217774244b7221b784d0d49ce3aa212f2c02a4e035c17e2329aca12e21d514b25466931c7d8f6a5aac84aa051ba30b396a0aac973d58e091473f5985"),
